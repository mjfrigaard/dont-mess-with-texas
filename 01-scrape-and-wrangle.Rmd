---
title: "Don't Mess with Texas Part 1: scraping the HTML tables"
...
Download the [selector gadget app](https://selectorgadget.com/) for your browser. You can identify the links using the [selector gadget](https://cran.r-project.org/web/packages/rvest/vignettes/selectorgadget.html).

```{r selector_gadget, out.width='70%', echo=FALSE}
# fs::dir_ls("image")
include_graphics("image/selector_gadget.png")
```
...
```{r test_url.png, out.width='70%', echo=FALSE, eval=TRUE}
include_graphics("figs/test_url.png")
```
